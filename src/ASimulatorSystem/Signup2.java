...
public class Signup2 extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            if (t2.getText().equals("")) {
                ...
                if (!isValidPAN(pan)) {
                    JOptionPane.showMessageDialog(null, "Enter a valid PAN number 5 uppercase 4 numeric 1 lowercase ");
                } else if (!isValidCnic(cnic)) {
                    JOptionPane.showMessageDialog(null, "Enter a valid 13 digit cnic number without dashes");
                } else {
                    Conn c1 = new Conn();
    ...
    private boolean isValidCnic(String cnic) {
        // Regex to validate cnic number
        String cnicRegex = "[0-9]{13}";

        return cnic.matches(cnicRegex);
    }
